...
(() => {
  ...
  var _getScrollNormalizer = function _getScrollNormalizer2(vars) {
    ...
    var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self, maxY, target = _getTarget(vars.target) || _docEl2, smoother = gsap3.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content2 = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale = 1, initialScale = (Observer.isTouch && _win4.visualViewport ? _win4.visualViewport.scale * _win4.visualViewport.width : _win4.outerWidth) / _win4.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction3(momentum) ? function() {
  ...
  var menuLink = $(".db_nav-menu-link");
  var content = $(".db_nav-menu-content");
  var dropdownWrap = $(".db_menu-wrapper");
  ...
  function revealDropdown(currentContent) {
    ...
    gsapWithCSS.set(currentContent, {
      opacity: 1
    });
  }
  ...
  var showDropdown = gsapWithCSS.timeline({
    paused: true,
    onReverseComplete: () => {
  ...
  var introDurationMS = 1200;
  var exitDurationMS = 800;
