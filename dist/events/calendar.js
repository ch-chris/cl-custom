...
(() => {
  ...
  // node_modules/.pnpm/@fullcalendar+core@6.1.9/node_modules/@fullcalendar/core/internal-common.js
  var styleTexts = [];
  ...
  // node_modules/.pnpm/@fullcalendar+core@6.1.9/node_modules/@fullcalendar/core/index.js
  var globalLocales = [];
  ...
  // node_modules/.pnpm/@fullcalendar+daygrid@6.1.9_@fullcalendar+core@6.1.9/node_modules/@fullcalendar/daygrid/internal.js
  ...
  // node_modules/.pnpm/@fullcalendar+daygrid@6.1.9_@fullcalendar+core@6.1.9/node_modules/@fullcalendar/daygrid/index.js
  ...
  // node_modules/.pnpm/@fullcalendar+list@6.1.9_@fullcalendar+core@6.1.9/node_modules/@fullcalendar/list/internal.js
  ...
  // node_modules/.pnpm/@fullcalendar+list@6.1.9_@fullcalendar+core@6.1.9/node_modules/@fullcalendar/list/index.js
  var OPTION_REFINERS = {
  ...
  // node_modules/.pnpm/@fullcalendar+rrule@6.1.9_@fullcalendar+core@6.1.9_rrule@2.7.2/node_modules/@fullcalendar/rrule/index.js
  var recurringType = {
  ...
  // src/events/utils/props.ts
  var renderListContent = function(info) {
  ...
  var renderGridContent = function(info) {
    const element = info.el;
  ...
  function getValueAtIndexOrReturn(value, index4, defaultValue) {
    if (Array.isArray(value)) {
      var v3 = value[index4];
      return v3 == null ? Array.isArray(defaultValue) ? defaultValue[index4] : defaultValue : v3;
    }
    return value;
  }
  ...
  // src/events/utils/tippy.ts
  tippy_esm_default.setDefaultProps({ maxWidth: "500px" });
  var myTippy = function(info) {
    ...
    myTipContent.forEach((content) => {
      ...
      div2.classList.add("ev_fc-tip-" + count);
      div2.textContent = content;
      fragment.appendChild(div2);
      count = count + 1;
    });
    const tip = tippy_esm_default(info.el, {
      theme: "ch",
      content: fragment,
      trigger: "click",
      animation: "fade"
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    const gridCalendarEl = document.querySelector('[ev-element = "grid-view"]');
    if (!gridCalendarEl)
      return;
    const listCalendarEl = document.querySelector('[ev-element = "list-view"]');
    if (!listCalendarEl)
      return;
    const getEvents = () => {
      const scripts = document.querySelectorAll('[ev-element = "event-data"]');
      const events2 = [...scripts].map((script) => {
        ...
        const event = JSON.parse(script.textContent, replacer);
