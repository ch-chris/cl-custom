...
(() => {
  ...
  gsapWithCSS.to(".db_h-scroll-track", {
    scrollTrigger: {
  ...
  gsapWithCSS.to(".db_video-wrapper", {
    scrollTrigger: {
  ...
  gsapWithCSS.set(".db_product-description", { opacity: 0 });
  gsapWithCSS.set(".db_product-gallery-wrapper", { opacity: 0 });
  gsapWithCSS.to(
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=skincare.js.map
